...
#[derive(Debug)]
pub struct LoadTesterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LoadTesterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LoadTester processing");
    
    let mut processor = LoadTesterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LoadTesterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LoadTesterProcessor::new(false);
